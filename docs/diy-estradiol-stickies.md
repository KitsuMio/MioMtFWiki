...
|状态或时间点|雌二醇|睾酮|
|---|---:|---:|
|停用激素替代治疗（HRT）时|69 pmol/L（约 19 pg/mL）|35 nmol/L（约 1009 ng/dL）|
|给药后 6 小时（T + 6 h）|434 pmol/L（约 118 pg/mL）|6.9 nmol/L（约 199 ng/dL）|
|给药后 24 小时（T + 24 h）|272 pmol/L（约 74 pg/mL）|14 nmol/L（约 404 ng/dL）|
...
|用量|原料|
|---:|---|
|8 mg|雌二醇（4 片 × 2 mg 的仿制药雌二醇片，按从药房取得时的原样使用）|
|1.2 mL（约 1/4 茶匙）|瓜尔胶|
|3.1 mL（约 5/8 茶匙）|水|
